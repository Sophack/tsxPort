  ...
  return (
    <footer className="mx-auto max-w-3xl px-4 sm:px-6 md:max-w-5xl ">
      ...
      <div className="mx-auto  p-4 flex flex-col text-center text-violet-900 md:flex-row md:justify-between">
        <div className="flex flex-row items-center justify-center space-x-1 text-violet-500 dark:text-violet-100">
        ...
        <div className="flex flex-row items-center justify-center space-x-2 mb-1">
          <a href="https://github.com/Sophack" rel="noreferrer" target="_blank">
            <FaGithub
              className="hover:-translate-y-1 transition-transform cursor-pointer text-violet-500 dark:text-violet-100"
              size={30}
            />
          </a>
          <a
          ...
          >
            <FaStackOverflow
              className="hover:-translate-y-1 transition-transform cursor-pointer text-violet-500 dark:text-neutral-100"
              size={30}
            />
          </a>
        </div>
